...
# Read a shapefile
getwd()
pa_counties <- st_read("Github/portfolio-setup-jedchewjm/lectures/week-04/data/Pennsylvania_County_Boundaries.shp")

# Read GeoJSON
districts <- st_read("Github/portfolio-setup-jedchewjm/lectures/week-04/data/districts.geojson")
hospitals <- st_read("Github/portfolio-setup-jedchewjm/lectures/week-04/data/hospitals.geojson")
...
#click on "I want to use this (bottom)" and copy geojson link below
...
#cb stands for cartographic boundary, and when TRUE, the function retrieves a simplified boundary file
