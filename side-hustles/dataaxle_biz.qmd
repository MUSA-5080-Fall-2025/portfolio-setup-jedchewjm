...
-   Filter by Neighborhood (Pennsylvania \> PHL \> Sharswood) or Zip
    Code (19122) and check "Omit: ATM and Kiosk"
-   Click on "View Results" in the top right-hand corner of the screen

![](images/clipboard-3282527950.png){width="887"}

-   On the results page, select each page (25 records per page) and click on
    "Download"
-   On the downloads page, select the CSV file format as well as the custom
    fields shown below and click on "Download Records" at the bottom of the
    screen

![](images/clipboard-3998417965.png)
