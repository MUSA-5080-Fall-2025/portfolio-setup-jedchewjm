...
facet_metric("pct_renter", "Hillsboro: % Renter Households", "%", fill_lab_fmt = pct_fmt, text_fmt = pct_fmt)
facet_metric("pct_rent_burden","Hillsboro: % Renters Cost Burdened", "%", fill_lab_fmt = pct_fmt, text_fmt = pct_fmt)
facet_metric("pct_income_75_125k", "Hillsboro: % Households $75k–$125k", "%", fill_lab_fmt = pct_fmt, text_fmt = pct_fmt)
facet_metric("median_rentE",   "Hillsboro: Median Gross Rent", "$", fill_lab_fmt = dol_fmt, text_fmt = dol_fmt)
facet_metric("vacancy_rate",   "Hillsboro: Housing Vacancy Rate", "%", fill_lab_fmt = pct_fmt, text_fmt = pct_fmt)
```
